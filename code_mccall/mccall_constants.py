...
densification_method = 'Boone'               #MODIFIED   # possibilities: 'Boone','empirical','constant' TODO: solve error Vionnet
...
thermal_conductivity_method = 'bulk'		  #MODIFIED  # possibilities: 'bulk', 'empirical'
sfc_temperature_method = 'Newton'                #MODIFIED possibilities: 'L-BFGS-B', 'SLSQP'(faster), 'Newton' (Secant, fastest)'
...
' INITIAL CONDITIONS '
initial_snowheight_constant = 0.533              # MODIFIED Initial snowheight
initial_snow_layer_heights = 0.10               # Initial thickness of snow layers
initial_glacier_height = 50.0                   # Initial glacier height without snowlayers
...
minimum_snow_layer_height = 0 #0.001               # minimum layer height
#MODIFY THIS?
minimum_snowfall = 0 # 0.001                        # minimum snowfall per time step in m which is added as new snow
...
albedo_ice = 0.2                                # McCall:0.2! albedo of ice: 0.3 [-] (Moelg et al. 2012, TC)
albedo_mod_snow_aging = 10                   #MODIFIED   # effect of ageing on snow albedo [days] (Oerlemans and Knap 1998, J. Glaciol.)
